...
INSERT INTO document_type (id, name, code)
VALUES
 (1, 'Паспорт гражданина РФ', '21'),
 (2, 'Свидетельство о рождении', '03'),
 (3, 'Вид на жительство в Российской Федерации', '12');

INSERT INTO document (id, number, date, document_type_id)
VALUES
 (1, '666053', '2011-04-04', 1),
 (2, '627812', '1991-01-15', 2),
 (3, '006074', '2001-02-12', 3);
